...
export const useTheme = () => {
	...
	useLayoutEffect(() => {
		document.documentElement.setAttribute('class', theme) // document.documentElement.setAttribute('data-theme', theme)
	  localStorage.setItem('class', theme) // localStorage.setItem('app-theme', theme)
	}, [theme])
